...
def get_meals():
    ...
    meals_dict = [{"id": meal.id, "name": meal.name, "description": meal.description, "user_id": meal.user_id, "inside_diet": meal.inside_diet , "created_at": meal.created_at} 
                    for meal in meals]
